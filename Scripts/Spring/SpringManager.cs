...
namespace GraduationProject
{
	public class SpringManager : MonoBehaviour
	{
		...
		public SpringBone[] springBones {get; private set;}

		void Awake ()
		{
			springBones = GetComponentsInChildren<SpringBone> ();
			SpringCollider[] scs = GetComponentsInChildren<SpringCollider> ();
			foreach (SpringBone child in springBones)
			{
				child.SetSpringCollider (scs);
			}
		}
